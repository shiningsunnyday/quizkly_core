...
class TestFilterGaps(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        sentence_sets = [
            ["The tricuspid valve has three cusps, which connect to chordae tendinae" \
            ...
            ["John went to the market.", "He bought snacks.", "He loves chocolates."],
    ...
    def test_dep_context(self):
        for i, docs in enumerate(self._doc_sets):
            self.assertEqual(self._expected[i], dep_context(docs[:-1], docs[-1]))
